...
def get_weather(request):
    ...
    #if ip_address:
    url = f"http://api.weatherapi.com/v1/current.json?key={token}&q={ip_address}&aqi=no&days=5"
    ...
    # s = "You're in {}, {}. You can expect {} conditions with a temperature of {} degrees.".format(
    #     city, state_code, description, temperature)
    s = weather_data
    data = {"weather_data": s, "forecast": forecastDict}
